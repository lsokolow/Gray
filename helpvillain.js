...
// var hero= Crafty.sprite('https://vignette.wikia.nocookie.net/typemoon/images/7/7a/Artoria%27s_Mysterious_Heroine_Clothes.png/revision/latest?cb=20170123154123',{hero:[0,0,10,10]});
// var villain= Crafty.sprite('https://vignette.wikia.nocookie.net/fategrandorder/images/7/78/MHXAlterSprite3.png/revision/latest?cb=20170208224030',{villain:[0,0,10,100]});
...
function enemy(){
  ...
  .attr({x: 620, y: 300, w: 40, h: 90, health: 10})
  .gravity("Floor")
  // .twoway(200)
...
// When panda touches enemy 20 times then enemy dissapears
